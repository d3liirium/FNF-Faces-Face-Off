...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["What a Fuckin' Disaster!",	"Complete a Song with a rating lower than 20%.",	'ur_bad',				false],
		...
		["Face Off",					"Beat FACE's week with no misses.",					'face_nomiss',			false],
		["I Guess That's It?",			"Beat FACE's week with no misses.",					'shite',				true],
		["Ratio!",						"Go up against Anne, the BasedGoddess.",			'anne',					true],
